...
@section('title')
    School Age Care at Youth Skills Center - A Preschool and Childcare Center in Riverside, CA | Ages 2-14
@stop
...
@section('content')
    <!-- Header -->
        <header>
            <div class="container">
                <div class="intro-text text-left">
                    <div class="intro-heading highlighted-heading accent-two">School Age Care</div>
                    <div class="row">
                        <div class="col-md-8 ">
                            <p class="lead highlighted-inline accent-translucent-dark">
                                With ultra-low student to teacher ratios, your children can get the attention they deserve in our focused, technology-enhanced before and after school programs.
                            </p>
                        </div>
                    </div>
                    <a href="#scrolled" class="page-scroll btn btn-xl accent-two">Learn More</a>
                </div>
            </div>
        </header>

        <section id="scrolled" class="thin bg-accent-two">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <h1 class="text-accent-two"><strong>YSC School Age Care.</strong> Focused. Fruitful.</h1>
                        <p class="lead">
        ...
        <section class="thin feature" id="swimming">
            <div class="container feature-text">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <h2 class="accent-one">Summertime Fun in the Water</h2>
                        <div class="feature-body">
                            In the summertime, you will have to option of allowing your child to swim &mdash; and learn
                            to swim &mdash; in our new swimming pool ... completely free of charge! Our summer programs
                            are also filled with numerous exciting field trips and other unique activities, without the
                            hassle and stress of arranging and planning.
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <h2 class="text-accent-two">Peace of Mind with Transportation</h2>
                        <img class="img-responsive img-padded-vertical" src="/img/banners/transportation.jpg"  />
                        <p>
        ...
        <section class="thin bg-accent-three">
