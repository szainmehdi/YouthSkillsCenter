...
@section('my-ysc-content')
    ...
    {{ Form::open(['method' => 'post', 'class' => 'form-horizontal', 'role' => 'form']) }}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input class="form-control" type="text" placeholder="" id="first_name" name="first_name" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label" for="last_name">Last Name</label>
            <div class="col-sm-5">
                <input class="form-control" type="text" placeholder="" id="last_name" name="last_name" />
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-5">
                    <div class="input-group">
                        ...
                        <input class="form-control" type="number" step="any" min="10" max="500" placeholder="" id="weekly_tuition" name="weekly_tuition" />
                    </div>
            </div>
        </div>
