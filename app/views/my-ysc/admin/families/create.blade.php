...
@section('my-ysc-content')
    ...
    {{ Form::open(['route' => 'manage.families.doCreate', 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'form']) }}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input class="form-control" type="text" placeholder="TOR-2039" id="family_key" name="family_key" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label" for="nickname">Nickname <small>(Optional)</small></label>
            <div class="col-sm-5">
                <input class="form-control" type="text" placeholder="The Torres Family" id="nickname" name="nickname" />
            </div>
        </div>
        <div class="form-actions form-group">
            <div class="col-sm-12">
                <button type="submit" class="btn btn-primary">Add Family</button>
                <a href="{{ URL::route('manage.families') }}" class="btn btn-default"><i class="fa fa-times"></i> &nbsp; Cancel</a>
            </div>
        </div>
    {{ Form::close() }}
