...
class Database //renamed class from 'Database' to simpler 'Database'
{
    ...
    /***
     *
     * Protected default database values
     */
    ...
    */
     ...
     */
    public function get($tableName, $columns = null, $numRows = null)
    {
        if($columns==null) {
        ...
        /* READ THROUGH THE RESULTS MULTI_DIMENSIONAL ARRAY USING THIS CODE
        ...
        //added by szm on 7/18/2013
        */

        /* ADDED OPTION TO SELECT ONLY CERTAIN COLUMNS IN THE TABLE
            $db->get("table", "name, id, phone"); //example
        //added by szm on 7/18/2013
        */
    }
    ...
    public function update($tableName, $tableData)
    {
        ...
        return ($stmt->affected_rows >= 0) ? $result = true : $result = false;
    }
    ...
    public function createTable($table) {
        ...
        if(!$this->tableExists($table)) {
            //parse the sql file to import.
            parseSQL($cfg['root_dir'] . "sql/" . $table . ".sql");
        }
    }
